...
eligible = **{v056-gbdt-v9b 929.8, v057-v054-reship 901.7}**。**268位 / 6,701チーム**で、
silver（上位5%）の cut は 902.7 ——**27.1点の余裕で圏内**。bronze cut は 839.7。
締切は 8/16（Simulation、あと6日）と 9/13（Strategy、あと34日）です。
順位としては過去最高（昨日 375位 → 268位）。
