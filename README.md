...
eligible = **{v060-v056-redraw 959.8, v061-v056-redraw2（提出直後）}**。LB = **959.8**、
**189位 / 6,800チーム**で silver cut 906.8 に対し **+53.0 の余裕**。過去最高順位。
...
これで棄却リストは、特徴量5連敗 / データ量4連敗 / 教師選抜3連敗 / デッキ5連敗 / 分布1敗。
**手法側はやり尽くした。** 引きのばらつき（同じビルドで 880〜959.8）が最大の変数で、
