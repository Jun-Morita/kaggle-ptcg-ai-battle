...
**eligible = {v016-wall, v019-searchpri3}**（07-13再提出、収束中）。シルバーカット:
**933.4点**、締切8/16（Simulation）・9/13（Strategy）。
...
**次アクション**: LOミルの唯一の弱点dragapult(0.297)を、v016壁側の耐久パーツを寄せた
デッキ比率調整（exp027で全マッチアップ改善に成功したレバー）で埋められるか検証 →
勝った変種を`/build-submit`。CRNにより複数変種の比較コストが現実的になった。
