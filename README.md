...
eligible = **{v046 734.5, v047 828.1（v045のコピー、収束中）}**。silver cut は **#296 = 915.8 / 5936チーム**。締切は 8/16（Simulation）と 9/13（Strategy）です。

### 07-31: 教師データに Mega Lucario ex（メガルカリオex）がいなかった（exp083j）
