...
eligible = **{v058-gbdt-v13, v059-gbdt-v10rL}**（どちらも提出直後、μ600 から収束中）。
提出直前は **248位 / 6,730チーム**、v056 が 932.9 で silver cut 905.0 に対し +27.9。
締切は 8/16（Simulation、あと5日）と 9/13（Strategy、あと33日）です。
