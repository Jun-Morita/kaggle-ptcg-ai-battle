...
eligible = **{v058-gbdt-v13 875.2, v059-gbdt-v10rL 932.9}**。LB = **932.9**、
silver cut は 909.1（338位 / 6,763チーム）で **+23.8 の余裕**。
締切は 8/16（Simulation、あと4日）と 9/13（Strategy、あと32日）です。
