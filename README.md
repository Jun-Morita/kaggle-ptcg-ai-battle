...
eligible = **{v060-v056-redraw 970.3, v061-v056-redraw2 770.2（収束中）}**。LB = **970.3**、
**170位 / 6,804チーム**で silver cut 909.1 に対し **+61.2 の余裕**。過去最高順位。
締切は 8/16（Simulation、あと2日）と 9/13（Strategy、あと30日）です。
