...
eligible = **{v054-gbdt-v6 954.2, v055-gbdt-q1075（提出直後）}**。**199位 / 6,616チーム**で、
silver（上位5%）の cut は 904.7 ——**49.5点の余裕で圏内**。bronze cut は 841.0。
締切は 8/16（Simulation、あと7日）と 9/13（Strategy、あと35日）です。
