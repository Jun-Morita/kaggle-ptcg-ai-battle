...
**eligible = {v027 koff (591.7, 低迷ロック=次のリロール対象), v028 koff (796.3, day1判定中)}**。
silver cut **919.4**・bronze 869.3・5188チーム（silver=259位以内）。
締切8/16（Simulation）・9/13（Strategy）、最終提出目標8/2。
koff引き履歴: 942/708/745/759/592/796——分散大、**早期判定ルール**（day1-2で<800なら引き直し、
公式マッチメーカー仕様disc726690の経路依存ロックインに基づく）でリロール高回転中。
