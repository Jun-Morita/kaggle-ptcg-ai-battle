...
fig, ax = plt.subplots(figsize=(10.6, 5.9625), dpi=220)
...
fig.suptitle("Marnie's Grimmsnarl ex — one Ability pays the Energy, two do the arithmetic",
             x=0.008, y=0.974, ha="left", fontsize=13, color=INK, fontweight="bold")
fig.subplots_adjust(left=0.012, right=0.988, top=0.906, bottom=0.019)
