...
| `public_meta_a_archaludon_0708.md` | **公開Archaludon ex/Cinderaceデッキ**(876.9)。**"hop"(=我々のデッキ)専用対策**（Snorlax名指しBoss狙撃、想定最大打点220前提のIce Cream判断）を実装済み | archaludon戦(我々最弱0.17-0.195)の相手視点の脅威モデル理解、Snorlax運用の見直し検討 |
