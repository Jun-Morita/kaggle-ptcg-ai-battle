...
| v004 | 2026-06-18 | exp007_anti_crustle | vs ex Lucario 0.69 / Dragapult 1.00 / crustle mirror 0.62 / vs v003 0.38 / mirror 0err / max_move 0.01s | _PENDING (ref 53807492)_ | submit/v004_exp007_crustle_mimic/submission.tar.gz | exp007 / リプレイメタ分析 / ladder Crustle decklist | **模倣**: トップ戦略 Crustle anti-ex 壁コントロール（実ポケカ Safeguard control）。ex 環境を制圧。v003 と対の2枚看板 |
| v003 | 2026-06-18 | exp007_anti_crustle | vs Crustle **0.55**(v001=0.10) / mirror 0.50 / random 1.00 / mirror 0エラー / max_move 0.02s | **726.1 / 701.5**（収束途中, ref 53807320/53807311 重複） | submit/v003_exp007_anti_crustle/submission.tar.gz | exp007 / リプレイメタ分析 / exp002 lucario_v2 | **アンチ Crustle**: ex/megaEx が ex-免疫(Safeguard)に0ダメ→非ex Hariyama 線へ自動切替。**注意: 提出直後でμ600から収束途中**。v001(成熟915)との比較は収束後 |
