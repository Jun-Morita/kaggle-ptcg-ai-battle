...
def _tinka_score_to_hand(self, card):
    ...
    if pid == _TINKATON and self.field_counts[_TINKATINK] == 0 and self.hand_counts[_TINKATINK] == 0             and self.field_counts[_TINKATUFF] == 0 and self.field_counts[_TINKATON] == 0:
