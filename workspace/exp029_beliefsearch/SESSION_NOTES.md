...
## 追記 2026-07-04: guard×turnbeam 合成評価 と ex_lucario 0.860 の再解釈
- 合成（GUARD_BASE=turnbeam, ロールアウトは素 pilot に分離）n=200:
  ex 0.775 / crustle 0.870 / dragapult 0.160 / mirror 0.620 / arch 0.185 = 合計 2.61, paired v012 0.570。
- **順位: beam単体 2.67 > 合成 2.61 > guard 2.58**。合成は両エッジを完全には両立せず。
- **重要**: guard の看板 ex_lucario 0.860 は、guard+exact(0.770)・guard+beam(0.775) の
  独立2再測で再現せず＝**ローカル上振れだった可能性が高い**（±0.09 ≈ 2.6SE は起こる。
  disc 712621 の「±150 はノイズ」のローカル版教訓）。guard の実効は「無害＋mirror/ex 微益」程度と再評価。
- 帰結: **v014 = turn-beam 単体を提出**（2026-07-04, eligible={v014, v013}＝異メカニズム2枚看板）。
