"""exp036 rigorous eval — GA champion genome vs the exp035 field/paired protocol
(same matchups, n, and opponent constructions as v014's benchmark, for apples-to-
apples comparison). MATCH=field|v012|v014, ONLY=<name>. Usage: uv run python eval_champion.py [n]
"""
...
CHAMP = json.load(open(os.path.join(os.path.dirname(__file__), "champion.json")))["genome"]
...
def main():
    ...
    cand = GP.make_agent(V_TREV, CHAMP)
    if mode == "v012":
