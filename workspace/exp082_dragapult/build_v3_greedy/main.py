        ...
        if remain_prize <= base_prize_count:
            ...
            for indices in counter_indices:
                ...
                if remain_prize <= prize:
                    ...
                    # exp082 V3: invert to prize-greedy -- reward taking prizes now,
                    # neutral on pure spread. Tests whether skarin's spread-first
                    # philosophy costs tempo vs the field.
                    if prize >= 2:
                        score += 1500
                    elif prize == 1:
                        score += 500
