...
REPLAY_DIR = os.path.join(ROOT, "references", "raw", "replays", "0725_54936705")
KOFF_DECK = [int(x) for x in open(os.path.join(WS, "exp071_bundlefix", "build", "deck.csv")).read().split()[:60]]
